...
import { useCurrentSidebarCategory } from '@almas222/theme-common'
...
[contributing]: https://github.com/almas222/tauri-apps/tauri/blob/dev/.github/CONTRIBUTING.md
[`create-tauri-app`]: https://github.com/almas222/tauri-apps/create-tauri-app
